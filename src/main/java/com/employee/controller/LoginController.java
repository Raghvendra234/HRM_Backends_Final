		...
		if(authenticate.isAuthenticated())
			{
				 ...
				 //Get EmailId from user table for getting EmployeeId
				 int employeeId=this.employeeRepo.getEmployeeId(username); 
				 System.out.println("Employee id ++++++++++++++++++++++");
				 System.out.println(employeeId);
				 
				 
						 
				 return new ResponseEntity<TokenResponse>((new TokenResponse("login Successfully",generateToken, role,navs, employeeId)),HttpStatus.OK);
